...
#It gives eiter Nan or Inf
2.	Why are we multiplying the results of the atan and atan2 functions by 180/pi?
#It turns the output of the function into degrees
3.	How is the atan2 function different from the atan function?
#atan2 takes two arguments, both an x and y component
4.	What is the difference between log and log10?
#log is the natural log, with a base of e, while log10 is a logarithm with a base #10
...
#sum gives the sum of two numbers that are next to each other in teh vector, and cumsum gives the sume of all the values in the vector
...
#> diff(x)
#[1] 0.1957143 0.1957143 0.1957143 0.1957143 0.1957143 0.1957143 0.1957143
...
#"2"|1.3|2.87623092770957|"red"|FALSE

#dat2=read.table("data/Lab1_frogs.txt", header=TRUE, sep="|")
...
#> x<-c("superman", "aquaman", "daredevil", "storm")
#> as.character(x)
#[1] "superman"  "aquaman"   "daredevil" "storm"    
...
#> subset(dat, frogs>5 | spots==FALSE)
#   frogs tadpoles color spots
#2    1.3 2.876231   red FALSE
#4    1.8 3.707180   red FALSE
#6    2.1 4.786983   red FALSE
...
#> plotting=function(x,y){lm(y~x)
#+     plot(lm(y~x))
#+     abline(x,y)
#+     return(summary(x,y))
#+     }

#> plotting(dat$tadpoles[dat$tadpoles>=5],dat$frogs[dat$tadpoles>=5])
```
